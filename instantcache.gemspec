...
local memory.}
  ...
  s.files = ["History.txt", "Manifest.txt", "README.rdoc", "Rakefile", "lib/instantcache.rb", "lib/instantcache/exceptions.rb", "script/console", "script/destroy", "script/generate", "test/test_helper.rb", "test/test_instantcache.rb", "test/test_sharing_simple.rb", "test/test_sharing_complex.rb", ".gemtest"]
